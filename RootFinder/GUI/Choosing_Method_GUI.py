...
class Methods(Frame):
    def __init__(self,parent,*args, **kwargs):
        ...
        bisection_button = Button(methods, text='Bisection Method', command=self.bisection_handler, bg='black', fg='orange',
                                  pady='10')
        ...
        fixedPoint_button = Button(methods, text='Fixed Point', command=self.fixedPoint_handler, bg='black', fg='orange',
                                   pady='10')
